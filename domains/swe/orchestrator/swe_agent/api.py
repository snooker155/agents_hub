...
from domains.swe.orchestrator.tasks import TaskStore, Task
...
## Reuse step collection logic from domains.swe.orchestrator.swe_agent.agent to avoid duplication
