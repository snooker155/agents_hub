...
def plan(plan: str) -> str:
    ...
    `plan` only records your intended approach — it does not complete the task.
    After planning, carry out the steps and produce a final answer. Never end
    your turn having only called `plan`.
    """
    return plan
