...
const WorkspaceDetails = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const [wsRes, filesRes, agentsRes] = await Promise.allSettled([
        getWorkspace(name),
  ...
  const handleCreateTask = async (e) => {
    ...
    try {
      ...
      setNewTask({ title: '', description: '', should_decompose: false });
      fetchData();
    } catch {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <div className="lg:col-span-8 border border-gray-200 rounded-lg overflow-hidden">
                <div className="px-4 py-2 border-b bg-gray-50">
                  ...
                  <div className="text-sm font-mono text-gray-700 truncate">{selectedFilePath || '-'}</div>
                  {selectedFileSize > 0 && (
                ...
                <div className="p-4 max-h-[32rem] overflow-auto">
                  {fileContentLoading ? (
                    ...
                    <pre className="text-xs text-gray-800 whitespace-pre-wrap break-words font-mono">{selectedFileContent}</pre>
                  ) : (
