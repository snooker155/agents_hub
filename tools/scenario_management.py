...
@tool("list_environments_tool", args_schema=ListEnvironmentsInput)
def list_environments_tool() -> str:
    ...
    try:
        ...
        return _json_err(f"Failed to list environments: {e}")
...
@tool("list_scenarios_tool", args_schema=ListScenariosInput)
def list_scenarios_tool(workspace: Optional[str] = None) -> str:
    ...
    try:
        ...
        return _json_err(f"Failed to list scenarios: {e}")
...
@tool("create_scenario_tool", args_schema=CreateScenarioInput)
def create_scenario_tool(
    name: str,
    environment: str,
    ...
    try:
        ...
        return _json_err(f"Failed to create scenario: {e}")
...
@tool("get_scenario_tool", args_schema=GetScenarioInput)
def get_scenario_tool(scenario_id: str) -> str:
    ...
    try:
        ...
        return _json_err(f"Failed to get scenario: {e}")
...
@tool("modify_scenario_tool", args_schema=ModifyScenarioInput)
def modify_scenario_tool(
    scenario_id: str,
    ...
    try:
        ...
        return _json_err(f"Failed to modify scenario: {e}")
...
@tool("delete_scenario_tool", args_schema=DeleteScenarioInput)
def delete_scenario_tool(scenario_id: str) -> str:
    ...
    try:
        ...
        return _json_err(f"Failed to delete scenario: {e}")
...
@tool("validate_scenario_tool", args_schema=ValidateScenarioInput)
def validate_scenario_tool(
    ...
    try:
        ...
        return _json_err(f"Failed to validate scenario: {e}")
